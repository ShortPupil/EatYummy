...
function getUserProfilePicture(username) {
    if(username !== null && username !== ""){
        $.getJSON("/manage/login/profile_picture",{"username":username},function (data) {
            if(data.success){
    ...
    $("#img_profile_picture").attr("src","/static/image/manage/default_profile_picture-128x128.png");
}
