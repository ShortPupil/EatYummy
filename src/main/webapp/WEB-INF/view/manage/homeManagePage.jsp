...
<body>
<ul id="chartByDate">
    <li><span class="chartDateBtn text_info select">最近20天</span></li>
...
<ul id="chartTotal">
    <li id="restaurantTotal">
        <p class="chartTotalTitle"><span class="chartTitleText">餐厅</span><span class="chartTitleUnit"></span>
        </p>
        <span class="chartTotalValue">${requestScope.foodTotal}</span>
        <div class="chartTotalStyle" style="background-color: #b5f890"></div>
    </li>
    <li id="productTotal">
        <p class="chartTotalTitle"><span class="chartTitleText">上架食品</span><span class="chartTitleUnit"></span>
        </p>
        <span class="chartTotalValue">${requestScope.foodTotal}</span>
        <div class="chartTotalStyle" style="background-color: #f89e9e"></div>
    </li>
    <li id="userTotal">
        <p class="chartTotalTitle"><span class="chartTitleText">注册会员数量</span><span class="chartTitleUnit"></span>
        </p>
        <span class="chartTotalValue">${requestScope.memberTotal}</span>
        <div class="chartTotalStyle" style="background-color: #9ea7f5"></div>
    </li>
    <li id="orderTotal">
        <p class="chartTotalTitle"><span class="chartTitleText">订单数量</span><span class="chartTitleUnit"></span>
        </p>
