...
<div id="nav_main" class="text_info">
    ...
    <span id="txt_home_title" class="nav_text">Yummy!数据管理后台</span>
    ...
    <img id="img_home_profile_picture"
         ...
         onerror="this.src='${pageContext.request.contextPath}/static/image/buy/login/first.png'"
