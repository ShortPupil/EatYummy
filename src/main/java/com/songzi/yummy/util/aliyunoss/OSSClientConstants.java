package com.songzi.yummy.util.aliyunoss;
/**
...
public class OSSClientConstants {
    ...
    //阿里云API的bucket名称
    public static final String BACKET_NAME = "sell-resources";
    //阿里云API的文件夹名称,每个request一个folder，每次传入一个request新建一个以requestid命名的folder，并把图片传进去
    public static final String REQUEST_FOLDER="";
    //外网访问时的url 后接+resid+"\"+foodid+"/"+片名图
    public static final String URL = "https://sell-resources.oss-cn-beijing.aliyuncs.com/";
}
